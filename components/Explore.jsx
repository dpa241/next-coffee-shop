...
const Explore = () => {
  return (
    <section className="py-12 xl:py-0  lg:h-[90vh] xl:w-screen">
      <div className="container mx-auto xl:w-full xl:h-full flex xl:justify-center xl:items-center">
        <div className="w-full flex flex-col lg:flex-row gap-12 xl:gap-20">
          <div className="flex-1 flex flex-col justify-around items-end text-center lg:text-left gap-12 lg:gap-0 max-w-[400px] mx-auto lg:max-w-none lg:mx-0">
            <div className="reltaive flex items-center">
              <div className="xl:max-w-[420px] lg:text-right lg:flex lg:flex-col lg:items-end">
            ...
            <div className="reltaive flex items-center">
              <div className="lg:max-w-[420px] lg:text-right lg:flex lg:flex-col lg:items-end">
                <div className="mb-6 flex justify-center items-center">
                  <Image
          ...
          <div className="flex-1 flex flex-col justify-around items-end text-center lg:text-left gap-12 lg:gap-0 max-w-[400px] mx-auto lg:max-w-none lg:mx-0">
            <div className="reltaive flex items-center">
              <div className="lg:max-w-[420px] lg:text-left lg:flex lg:flex-col lg:items-start">
                <div className="mb-6 flex justify-center items-center">
                  <Image
